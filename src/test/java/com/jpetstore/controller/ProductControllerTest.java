...
class ProductControllerTest {
    ...
    void testCreateProduct() throws Exception {
        ...
        String json = "{\"productid\":\"FI-SW-99\",\"category\":\"FISH\",\"name\":\"TestFish\",\"description\":\"Test\"}";
    ...
    void testCreateProductWithBlankId() throws Exception {
        String json = "{\"productid\":\"\",\"category\":\"FISH\",\"name\":\"TestFish\"}";
    ...
    void testCreateProductWithBlankCategory() throws Exception {
        String json = "{\"productid\":\"FI-SW-99\",\"category\":\"\",\"name\":\"TestFish\"}";
    ...
    void testCreateProductWithBlankName() throws Exception {
        String json = "{\"productid\":\"FI-SW-99\",\"category\":\"FISH\",\"name\":\"\"}";
    ...
    void testUpdateProduct() throws Exception {
        ...
        String json = "{\"category\":\"FISH\",\"name\":\"Updated Fish\",\"description\":\"Updated\"}";
    ...
    void testUpdateProductFailure() throws Exception {
        ...
        String json = "{\"category\":\"FISH\",\"name\":\"Updated Fish\"}";
